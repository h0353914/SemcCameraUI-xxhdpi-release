...
class zzc$3 extends zzd<Status> {
    final /* synthetic */ zzc zzSF;
    final /* synthetic */ Credential zzSH;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    zzc$3(zzc zzcVar, GoogleApiClient googleApiClient, Credential credential) {
    ...
    protected void zza(Context context, zzh zzhVar) throws RemoteException {
        zzhVar.zza(new zzc$zza(this), new DeleteRequest(this.zzSH));
    }
