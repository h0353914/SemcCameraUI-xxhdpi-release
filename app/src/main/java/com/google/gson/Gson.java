...
public final class Gson {
    ...
    static /* synthetic */ void access$000(Gson gson, double d) {
    ...
    Gson(Excluder excluder, FieldNamingStrategy fieldNamingStrategy, Map<Type, InstanceCreator<?>> map, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, LongSerializationPolicy longSerializationPolicy, List<TypeAdapterFactory> list) {
        ...
        this.deserializationContext = new Gson$1(this);
        this.serializationContext = new Gson$2(this);
    ...
    public <T> TypeAdapter<T> getAdapter(TypeToken<T> typeToken) {
        ...
        Map<TypeToken<?>, Gson$FutureTypeAdapter<?>> map = this.calls.get();
        boolean z = false;
        if (map == null) {
            map = new HashMap<>();
            this.calls.set(map);
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                if (typeAdapterCreate != null) {
                    gson$FutureTypeAdapter2.setDelegate(typeAdapterCreate);
