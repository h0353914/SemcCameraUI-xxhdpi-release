...
class FocusRectangles$1 implements Runnable {
    final /* synthetic */ FocusRectangles this$0;

    FocusRectangles$1(FocusRectangles focusRectangles) {
    ...
    public void run() {
        ...
        if (FocusRectangles.access$3500(this.this$0)) {
            FocusRectangles.access$300(this.this$0).playTouchDownAnimation(imageView);
        } else {
