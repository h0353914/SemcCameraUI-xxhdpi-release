...
public class ImageLoader {
    ...
    /* JADX WARN: Type update failed for variable: r0v1 ??, new type: java.io.InputStream
    jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 4201. Try increasing type updates limit count.
     ...
     */
    /* JADX WARN: Type update failed for variable: r9v0 'this'  ??, new type: com.sonyericsson.cameracommon.storage.ImageLoader
    jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 4201. Try increasing type updates limit count.
    	at jadx.core.dex.visitors.typeinference.TypeUpdateInfo.requestUpdate(TypeUpdateInfo.java:37)
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.requestUpdate(TypeUpdate.java:224)
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.updateTypeForSsaVar(TypeUpdate.java:197)
    ...
    */
    public Bitmap load() throws Throwable {
        ...
        try {
            try {
                ...
                InputStream byteArrayInputStream2 = this.mImageData != null ? new ByteArrayInputStream(this.mImageData) : ContentResolverUtil.crOpenInputStream(this.mContext, this.mUri);
                ...
                try {
                    calcBounds(byteArrayInputStream2, this.mOption);
                    ...
                    if (byteArrayInputStream != null) {
                        try {
                            try {
                                bitmapLoadFullSize = loadFullSize(byteArrayInputStream, this.mOption);
                            } catch (Throwable th) {
                                th = th;
                                ...
                                if (inputStream2 != null) {
                                    try {
                                        ...
                                        CamLog.e("Close stream failed:" + e.toString(), e);
                                    }
                                }
                                throw th;
                            }
                        } catch (FileNotFoundException unused) {
                            bitmapLoadFullSize = bitmap;
                    ...
                    if (byteArrayInputStream != null) {
                        try {
                            ...
                            CamLog.e("Close stream failed:" + e8.toString(), e8);
                        }
                    }
                    return bitmap;
                } catch (FileNotFoundException unused7) {
                    InputStream inputStream6 = byteArrayInputStream2;
                    bitmapLoadFullSize = null;
                    ...
                    e = e9;
                    InputStream inputStream7 = byteArrayInputStream2;
                    bitmapLoadFullSize = null;
                    ...
                    InputStream inputStream8 = byteArrayInputStream2;
                    bitmapLoadFullSize = null;
                    ...
                    InputStream inputStream9 = byteArrayInputStream2;
                    bitmapLoadFullSize = null;
    ...
    private void calcBounds(InputStream inputStream, BitmapFactory$Options bitmapFactory$Options) throws InvalidObjectException, FileNotFoundException {
        if (CamLog.VERBOSE) {
            CamLog.d("calcBounds()");
        }
        ...
        Bitmap bitmapDecodeStream = decodeStream(inputStream, bitmapFactory$Options);
        ...
        if (CamLog.VERBOSE) {
            CamLog.d("BMP out height:" + bitmapFactory$Options.outHeight);
        }
        if (CamLog.VERBOSE) {
            CamLog.d("BMP out width:" + bitmapFactory$Options.outWidth);
        }
        if (CamLog.VERBOSE) {
            CamLog.d("Scale ratio:" + bitmapFactory$Options.inSampleSize);
        }
    }

    private Bitmap loadFullSize(InputStream inputStream, BitmapFactory$Options bitmapFactory$Options) throws InvalidObjectException, FileNotFoundException {
        if (CamLog.VERBOSE) {
    ...
    private Bitmap decodeStream(InputStream inputStream, BitmapFactory$Options bitmapFactory$Options) throws FileNotFoundException {
        Rect rect = new Rect(0, 0, 0, 0);
        if (CamLog.VERBOSE) {
            CamLog.d("Loading full size image started");
        }
        Bitmap bitmapDecodeStream = BitmapFactory.decodeStream(inputStream, rect, bitmapFactory$Options);
        if (CamLog.VERBOSE) {
            CamLog.d("Loading full size image finished");
        }
        return bitmapDecodeStream;
    ...
    private int calcRatio(BitmapFactory$Options bitmapFactory$Options, int i, int i2) {
        int i3 = bitmapFactory$Options.outWidth * i;
        int i4 = bitmapFactory$Options.outHeight * i;
