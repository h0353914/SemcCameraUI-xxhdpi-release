...
class TouchActionTranslator$SingleDown implements TouchActionTranslator$InteractionState {
    ...
    private TouchActionTranslator$SingleDown(TouchActionTranslator touchActionTranslator) {
        this.this$0 = touchActionTranslator;
    }

    /* synthetic */ TouchActionTranslator$SingleDown(TouchActionTranslator touchActionTranslator, TouchActionTranslator$1 touchActionTranslator$1) {
