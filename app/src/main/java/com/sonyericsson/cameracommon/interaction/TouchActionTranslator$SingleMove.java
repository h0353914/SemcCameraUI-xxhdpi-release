...
class TouchActionTranslator$SingleMove implements TouchActionTranslator$InteractionState {
    ...
    private TouchActionTranslator$SingleMove(TouchActionTranslator touchActionTranslator) {
        this.this$0 = touchActionTranslator;
    }

    /* synthetic */ TouchActionTranslator$SingleMove(TouchActionTranslator touchActionTranslator, TouchActionTranslator$1 touchActionTranslator$1) {
    ...
    public void handleSingleTouchStopEvent(Point point, Point point2, Point point3) {
        TouchActionTranslator.access$200(this.this$0).onSingleStopped(point, point2, point3);
        TouchActionTranslator.access$400(this.this$0, new TouchActionTranslator$SingleStop(this.this$0, null));
    }
}
