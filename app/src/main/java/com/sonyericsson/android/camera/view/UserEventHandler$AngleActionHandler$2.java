...
class UserEventHandler$AngleActionHandler$2 implements UserEventHandler$VariableUserEventTicker$OnEventTickedListener {
    final /* synthetic */ UserEventHandler$AngleActionHandler this$1;

    UserEventHandler$AngleActionHandler$2(UserEventHandler$AngleActionHandler userEventHandler$AngleActionHandler) {
    ...
    public void onTicked(UserEventHandler$VariableUserEventTicker userEventHandler$VariableUserEventTicker) {
        UserEventHandler$AngleActionHandler.access$6900(this.this$1);
    }
}
