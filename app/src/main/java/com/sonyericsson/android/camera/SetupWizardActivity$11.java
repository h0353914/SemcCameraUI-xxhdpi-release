...
/* synthetic */ class SetupWizardActivity$11 {
    ...
    static {
        try {
            $SwitchMap$com$sonyericsson$android$camera$SetupWizardActivity$InterruptedBy[SetupWizardActivity$InterruptedBy.LOCATION_SETTING.ordinal()] = 1;
        } catch (NoSuchFieldError unused) {
        }
        try {
            $SwitchMap$com$sonyericsson$android$camera$SetupWizardActivity$InterruptedBy[SetupWizardActivity$InterruptedBy.REQUEST_PERMISSION.ordinal()] = 2;
        } catch (NoSuchFieldError unused2) {
        }
        try {
            $SwitchMap$com$sonyericsson$android$camera$SetupWizardActivity$InterruptedBy[SetupWizardActivity$InterruptedBy.SIDE_SENSE_SETTING.ordinal()] = 3;
