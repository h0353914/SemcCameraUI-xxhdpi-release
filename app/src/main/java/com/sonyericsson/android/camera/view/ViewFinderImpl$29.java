...
class ViewFinderImpl$29 implements ValueAccessor<Float> {
    final /* synthetic */ ViewFinderImpl this$0;

    ViewFinderImpl$29(ViewFinderImpl viewFinderImpl) {
    ...
    public void set2(Float f) {
        ViewFinderImpl.access$1000(this.this$0).sendEvent(StateMachine$TransitterEvent.EVENT_ON_AMBER_BLUE_COLOR_CHANGED, f);
    }
