...
class ViewFinderImpl$14 implements TransitionAnimationController$TransitionAnimationCallback {
    final /* synthetic */ ViewFinderImpl this$0;
    final /* synthetic */ AnimationRequest val$request;

    ViewFinderImpl$14(ViewFinderImpl viewFinderImpl, AnimationRequest animationRequest) {
    ...
    public void onAnimationFinished() {
        if (this.val$request.mFrom.isFront() != this.val$request.mTarget.isFront()) {
            ...
            ViewFinderImpl.access$4800(this.this$0).post(new ViewFinderImpl$14$1(this, new AnimationRequest(AnimationRequest$AnimationType.MODE_SELECTOR, AnimationRequest$AnimationDegree.FINISH, this.val$request.mFrom, this.val$request.mTarget)));
        }
