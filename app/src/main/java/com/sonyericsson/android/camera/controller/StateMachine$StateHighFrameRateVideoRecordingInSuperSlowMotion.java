...
class StateMachine$StateHighFrameRateVideoRecordingInSuperSlowMotion extends StateMachine$StateVideoBase {
    ...
    public StateMachine$StateHighFrameRateVideoRecordingInSuperSlowMotion(StateMachine stateMachine) {
        super(stateMachine);
        this.this$0 = stateMachine;
        this.mAlreadyHighFrameRateRecordingDone = false;
        this.mCaptureState = StateMachine$CaptureState.STATE_HIGH_FRAME_RATE_VIDEO_RECORDING_IN_SUPER_SLOW_MOTION;
    ...
    public void handleSlowMotionFeedbackAnimationEnd(Object... objArr) {
        if (!this.mAlreadyHighFrameRateRecordingDone) {
            StateMachine.access$3400(this.this$0, new StateMachine$StateWaitForHighFrameRateVideoRecordingDone(this.this$0), new Object[0]);
            return;
        }
