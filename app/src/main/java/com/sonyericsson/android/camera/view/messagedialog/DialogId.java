...
public enum DialogId {
    ...
    APPLICATION_NOTIFICATION_NETWORK(new OkCancelDialogBuilder(), MessageDialogController.Priority.NORMAL, R.string.cam_strings_dialog_title_qrcode_wifi_ready_securityrisk_txt, R.string.cam_strings_dialog_body_qrcode_wifi_ready_securityrisk_txt, -1, R.string.cam_strings_ok_txt, R.string.cam_strings_cancel_txt, -1, -1, RotatableDialog.Cancelable.TRUE, RotatableDialog.Cancelable.USE_DEFAULT, MessageType.NO_MESSAGE, false),
    CONNECT_WIFI_SETTING(new OkCancelDialogBuilder(), MessageDialogController.Priority.NORMAL, R.string.cam_strings_dialog_title_qrcode_wifi_ready_txt, R.string.cam_strings_dialog_body_qrcode_wifi_ready_wifi_off_txt, -1, R.string.cam_strings_ok_txt, R.string.cam_strings_cancel_txt, -1, -1, RotatableDialog.Cancelable.TRUE, RotatableDialog.Cancelable.USE_DEFAULT, MessageType.NO_MESSAGE, false);
