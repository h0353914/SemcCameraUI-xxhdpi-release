...
class BypassCameraController$SnapshotFreeCallbackImpl implements BypassCamera$SnapshotFreeCallback {
    ...
    private BypassCameraController$SnapshotFreeCallbackImpl() {
    }

    /* synthetic */ BypassCameraController$SnapshotFreeCallbackImpl(BypassCameraController$1 bypassCameraController$1) {
        this();
    }
}
