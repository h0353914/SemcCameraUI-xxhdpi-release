...
public class OkCancelWithCheckBoxDialogBuilder extends MessageDialogBuilder {
    ...
    protected RotatableDialog create(Context context, int i, MessageSettings messageSettings, MessageDialogRequest messageDialogRequest, DialogInterface$OnClickListener dialogInterface$OnClickListener, DialogInterface$OnClickListener dialogInterface$OnClickListener2, DialogInterface$OnCancelListener dialogInterface$OnCancelListener, DialogInterface$OnDismissListener dialogInterface$OnDismissListener) {
        ...
        rotatableDialog$Builder.setPositiveButton(messageDialogRequest.mDialogId.positiveButtonResourceID, new OkCancelWithCheckBoxDialogBuilder$1(this, activity, messageDialogBuilder$MessageDialogCheckBoxListener, dialogInterface$OnClickListener));
        rotatableDialog$Builder.setNegativeButton(messageDialogRequest.mDialogId.negativeButtonResourceID, new OkCancelWithCheckBoxDialogBuilder$2(this, activity, messageDialogBuilder$MessageDialogCheckBoxListener, dialogInterface$OnClickListener2));
