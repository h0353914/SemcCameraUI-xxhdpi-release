...
/* synthetic */ class ShutterTriggerApplier$1 {
    ...
    static {
        try {
            $SwitchMap$com$sonyericsson$android$camera$configuration$parameters$ShutterTrigger[ShutterTrigger.SMILE_SHUTTER.ordinal()] = 1;
        } catch (NoSuchFieldError unused) {
        }
        try {
            $SwitchMap$com$sonyericsson$android$camera$configuration$parameters$ShutterTrigger[ShutterTrigger.GESTURE_SHUTTER.ordinal()] = 2;
