...
class BypassCameraController$RequestPrepareBurstShotTask extends CameraDeviceHandler$CameraDeviceAccessTask {
    ...
    /* synthetic */ BypassCameraController$RequestPrepareBurstShotTask(BypassCameraController bypassCameraController, CameraDeviceHandler$CameraSessionId cameraDeviceHandler$CameraSessionId, BypassCameraController$1 bypassCameraController$1) {
        this(bypassCameraController, cameraDeviceHandler$CameraSessionId);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    private BypassCameraController$RequestPrepareBurstShotTask(BypassCameraController bypassCameraController, CameraDeviceHandler$CameraSessionId cameraDeviceHandler$CameraSessionId) {
    ...
    public void doCameraDeviceAccess() {
        ...
        BypassCameraController.access$1200(this.this$0).requestPrepareBurstShot();
        Context contextAccess$1300 = BypassCameraController.access$1300(this.this$0);
        if (contextAccess$1300 != null) {
            new EachCameraStatusPublisher(contextAccess$1300, BypassCameraController.access$1400(this.this$0).getParameters(getSessionId()).getCameraId()).put(new BurstShooting(BurstShooting$Value.ON)).publish();
        }
    }
}
