...
/* synthetic */ class TransitionAnimationController$1 {
    ...
    static {
        ...
        try {
            $SwitchMap$com$sonyericsson$android$camera$view$animation$AnimationRequest$AnimationType[AnimationRequest$AnimationType.MODE_ICON.ordinal()] = 1;
        } catch (NoSuchFieldError unused5) {
        }
        try {
            $SwitchMap$com$sonyericsson$android$camera$view$animation$AnimationRequest$AnimationType[AnimationRequest$AnimationType.MODE_TOUCH.ordinal()] = 2;
