...
class BypassCameraController$FinishBurstCallbackImpl implements BypassCamera$FinishBurstCallback {
    ...
    private BypassCameraController$FinishBurstCallbackImpl() {
    }

    /* synthetic */ BypassCameraController$FinishBurstCallbackImpl(BypassCameraController$1 bypassCameraController$1) {
        this();
    }
}
