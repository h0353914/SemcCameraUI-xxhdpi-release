...
class VersionedParcelStream extends VersionedParcel {
    ...
    private final SparseArray<VersionedParcelStream$InputBuffer> mCachedFields = new SparseArray<>();
    ...
    public boolean readField(int i) {
        VersionedParcelStream$InputBuffer versionedParcelStream$InputBuffer = this.mCachedFields.get(i);
        if (versionedParcelStream$InputBuffer != null) {
            this.mCachedFields.remove(i);
            this.mCurrentInput = versionedParcelStream$InputBuffer.mInputStream;
            return true;
        }
        while (true) {
            try {
                ...
                VersionedParcelStream$InputBuffer versionedParcelStream$InputBuffer2 = new VersionedParcelStream$InputBuffer((i2 >> 16) & 65535, i3, this.mMasterInput);
                if (versionedParcelStream$InputBuffer2.mFieldId == i) {
                    this.mCurrentInput = versionedParcelStream$InputBuffer2.mInputStream;
                    return true;
                }
                this.mCachedFields.put(versionedParcelStream$InputBuffer2.mFieldId, versionedParcelStream$InputBuffer2);
    ...
    public void setOutputField(int i) {
        closeField();
        this.mFieldBuffer = new VersionedParcelStream$FieldBuffer(i, this.mMasterOutput);
