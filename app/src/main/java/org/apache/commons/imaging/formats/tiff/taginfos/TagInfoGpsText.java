...
public final class TagInfoGpsText extends TagInfo {
    ...
    private static final TagInfoGpsText$TextEncoding TEXT_ENCODING_UNICODE_LE = new TagInfoGpsText$TextEncoding(new byte[]{85, 78, 73, 67, 79, 68, 69, 0}, "UTF-16LE");
    private static final TagInfoGpsText$TextEncoding TEXT_ENCODING_UNICODE_BE = new TagInfoGpsText$TextEncoding(new byte[]{85, 78, 73, 67, 79, 68, 69, 0}, "UTF-16BE");
    private static final TagInfoGpsText$TextEncoding TEXT_ENCODING_UNDEFINED = new TagInfoGpsText$TextEncoding(new byte[]{0, 0, 0, 0, 0, 0, 0, 0}, "ISO-8859-1");
    private static final TagInfoGpsText$TextEncoding[] TEXT_ENCODINGS = {TEXT_ENCODING_ASCII, TEXT_ENCODING_JIS, TEXT_ENCODING_UNICODE_LE, TEXT_ENCODING_UNICODE_BE, TEXT_ENCODING_UNDEFINED};
    ...
    public byte[] encodeValue(FieldType fieldType, Object obj, ByteOrder byteOrder) throws ImageWriteException {
        TagInfoGpsText$TextEncoding tagInfoGpsText$TextEncoding;
        ...
        try {
            ...
            if (byteOrder == ByteOrder.BIG_ENDIAN) {
                tagInfoGpsText$TextEncoding = TEXT_ENCODING_UNICODE_BE;
            } else {
                tagInfoGpsText$TextEncoding = TEXT_ENCODING_UNICODE_LE;
            }
            byte[] bytes2 = str.getBytes(tagInfoGpsText$TextEncoding.encodingName);
            byte[] bArr2 = new byte[bytes2.length + tagInfoGpsText$TextEncoding.prefix.length];
            System.arraycopy(tagInfoGpsText$TextEncoding.prefix, 0, bArr2, 0, tagInfoGpsText$TextEncoding.prefix.length);
            System.arraycopy(bytes2, 0, bArr2, tagInfoGpsText$TextEncoding.prefix.length, bytes2.length);
            return bArr2;
    ...
    public String getValue(TiffField tiffField) throws ImageReadException {
        ...
        for (TagInfoGpsText$TextEncoding tagInfoGpsText$TextEncoding : TEXT_ENCODINGS) {
            if (BinaryFunctions.compareBytes(byteArrayValue, 0, tagInfoGpsText$TextEncoding.prefix, 0, tagInfoGpsText$TextEncoding.prefix.length)) {
                try {
                    String str = new String(byteArrayValue, tagInfoGpsText$TextEncoding.prefix.length, byteArrayValue.length - tagInfoGpsText$TextEncoding.prefix.length, tagInfoGpsText$TextEncoding.encodingName);
                    byte[] bytes = str.getBytes(tagInfoGpsText$TextEncoding.encodingName);
                    if (BinaryFunctions.compareBytes(byteArrayValue, tagInfoGpsText$TextEncoding.prefix.length, bytes, 0, bytes.length)) {
                        return str;
                    }
