...
/* synthetic */ class MostPopulatedBoxesMedianCut$1 {
    static final /* synthetic */ int[] $SwitchMap$org$apache$commons$imaging$palette$ColorComponent = new int[ColorComponent.values().length];

    static {
        try {
            $SwitchMap$org$apache$commons$imaging$palette$ColorComponent[ColorComponent.ALPHA.ordinal()] = 1;
