...
public final class RegexKt {
    @Nullable
    public static final /* synthetic */ MatchResult access$findNext(@NotNull Matcher matcher, int i, @NotNull CharSequence charSequence) {
        return findNext(matcher, i, charSequence);
    }

    @Nullable
    public static final /* synthetic */ MatchResult access$matchEntire(@NotNull Matcher matcher, @NotNull CharSequence charSequence) {
        return matchEntire(matcher, charSequence);
    }

    @NotNull
    public static final /* synthetic */ IntRange access$range(@NotNull java.util.regex.MatchResult matchResult) {
        return range(matchResult);
    }

    @NotNull
    public static final /* synthetic */ IntRange access$range(@NotNull java.util.regex.MatchResult matchResult, int i) {
        return range(matchResult, i);
    }

    public static final /* synthetic */ int access$toInt(@NotNull Iterable iterable) {
    ...
    private static final <T extends Enum<T> & FlagEnum> Set<T> fromInt(int i) {
        ...
        CollectionsKt.retainAll(enumSetAllOf, new RegexKt$fromInt$$inlined$apply$lambda$1(i));
    ...
    private static final IntRange range(@NotNull java.util.regex.MatchResult matchResult) {
        return RangesKt.until(matchResult.start(), matchResult.end());
    }

    private static final IntRange range(@NotNull java.util.regex.MatchResult matchResult, int i) {
