...
final class StringsKt__StringsKt$rangesDelimitedBy$4 extends Lambda implements Function2<CharSequence, Integer, Pair<? extends Integer, ? extends Integer>> {
    ...
    public final Pair<Integer, Integer> invoke(@NotNull CharSequence receiver, int i) {
        ...
        Pair pairAccess$findAnyOf = StringsKt__StringsKt.access$findAnyOf(receiver, this.$delimitersList, i, this.$ignoreCase, false);
        if (pairAccess$findAnyOf != null) {
            return TuplesKt.to(pairAccess$findAnyOf.getFirst(), Integer.valueOf(((String) pairAccess$findAnyOf.getSecond()).length()));
        }
        return null;
    }
}
