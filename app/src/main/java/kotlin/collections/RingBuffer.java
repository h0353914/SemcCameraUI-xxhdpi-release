...
final class RingBuffer<T> extends AbstractList<T> implements RandomAccess {
    ...
    public static final /* synthetic */ int access$forward(RingBuffer ringBuffer, int i, int i2) {
        return ringBuffer.forward(i, i2);
    }
    ...
    public static final /* synthetic */ void access$setSize$p(RingBuffer ringBuffer, int i) {
        ringBuffer.setSize(i);
    }

    public static final /* synthetic */ void access$setStartIndex$p(RingBuffer ringBuffer, int i) {
        ringBuffer.startIndex = i;
    }
