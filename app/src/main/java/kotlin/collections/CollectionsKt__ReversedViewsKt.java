...
class CollectionsKt__ReversedViewsKt extends CollectionsKt__MutableCollectionsKt {
    public static final /* synthetic */ int access$reverseElementIndex(@NotNull List list, int i) {
        return reverseElementIndex$CollectionsKt__ReversedViewsKt(list, i);
    }

    public static final /* synthetic */ int access$reversePositionIndex(@NotNull List list, int i) {
