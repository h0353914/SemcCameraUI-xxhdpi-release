...
public final class SafeContinuation$Companion {
    @JvmStatic
    private static /* synthetic */ void RESULT$annotations() {
    }

    private SafeContinuation$Companion() {
    }

    public /* synthetic */ SafeContinuation$Companion(DefaultConstructorMarker defaultConstructorMarker) {
        this();
    }
}
