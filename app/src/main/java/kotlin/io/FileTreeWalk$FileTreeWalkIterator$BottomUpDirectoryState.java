...
final class FileTreeWalk$FileTreeWalkIterator$BottomUpDirectoryState extends FileTreeWalk$DirectoryState {
    ...
    public FileTreeWalk$FileTreeWalkIterator$BottomUpDirectoryState(@NotNull FileTreeWalk$FileTreeWalkIterator fileTreeWalk$FileTreeWalkIterator, File rootDir) {
        super(rootDir);
    ...
    public File step() {
        if (!this.failed && this.fileList == null) {
            ...
            if (this.fileList == null) {
                Function2 function2Access$getOnFail$p = FileTreeWalk.access$getOnFail$p(this.this$0.this$0);
