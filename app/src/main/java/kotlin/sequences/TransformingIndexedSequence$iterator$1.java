...
public final class TransformingIndexedSequence$iterator$1<R> implements Iterator<R>, KMappedMarker {
    ...
    @Override // java.util.Iterator
    public R next() {
        Function2 function2Access$getTransformer$p = TransformingIndexedSequence.access$getTransformer$p(this.this$0);
        int i = this.index;
        this.index = i + 1;
        return (R) function2Access$getTransformer$p.invoke(Integer.valueOf(i), this.iterator.next());
    }
