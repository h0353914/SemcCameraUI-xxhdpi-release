...
class PreferenceFragmentCompat$DividerDecoration extends RecyclerView$ItemDecoration {
    private boolean mAllowDividerAfterLastItem = true;
    private Drawable mDivider;
    private int mDividerHeight;
    final /* synthetic */ PreferenceFragmentCompat this$0;

    PreferenceFragmentCompat$DividerDecoration(PreferenceFragmentCompat preferenceFragmentCompat) {
