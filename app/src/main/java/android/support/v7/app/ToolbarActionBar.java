...
class ToolbarActionBar extends ActionBar {
    ...
    ToolbarActionBar(Toolbar toolbar, CharSequence charSequence, Window$Callback window$Callback) {
        this.mDecorToolbar = new ToolbarWidgetWrapper(toolbar, false);
        this.mWindowCallback = new ToolbarActionBar$ToolbarCallbackWrapper(this, window$Callback);
