...
class TwilightManager {
    ...
    private void updateState(@NonNull Location location) {
        ...
        twilightManager$TwilightState.yesterdaySunset = j2;
        twilightManager$TwilightState.todaySunrise = j3;
        twilightManager$TwilightState.todaySunset = j4;
        twilightManager$TwilightState.tomorrowSunrise = j5;
