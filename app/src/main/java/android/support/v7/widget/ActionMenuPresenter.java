...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider$SubUiVisibilityListener {
    ...
    public boolean onSubMenuSelected(SubMenuBuilder subMenuBuilder) {
        ...
        this.mActionButtonPopup = new ActionMenuPresenter$ActionButtonSubmenu(this, this.mContext, subMenuBuilder, viewFindViewForItem);
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mReserveOverflow && (z2 || i6 + i5 > i7)) {
            i7--;
        }
        int i9 = i7 - i5;
        ...
        while (i12 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                boolean z4 = (i9 > 0 || z3) && i11 > 0 && (!r02.mStrictWidthLimit || iMeasureChildForCells > 0);
                if (z4) {
                    boolean z5 = z4;
                    ...
                    z4 = r02.mStrictWidthLimit ? z5 & (i11 >= 0) : z5 & (i11 + i10 > 0);
                } else {
                    i2 = size;
                }
                if (z4 && groupId2 != 0) {
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (parcelable instanceof ActionMenuPresenter$SavedState) {
            ...
            if (actionMenuPresenter$SavedState.openSubMenuId <= 0 || (menuItemFindItem = this.mMenu.findItem(actionMenuPresenter$SavedState.openSubMenuId)) == null) {
                return;
            }
