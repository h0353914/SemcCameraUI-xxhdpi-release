        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (linearLayoutCompat$LayoutParams.width == -1) {
                    ...
                    linearLayoutCompat$LayoutParams.height = childAt.getMeasuredHeight();
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                ...
                int i11 = paddingTop + linearLayoutCompat$LayoutParams.topMargin;
                setChildFrame(childAt, i5, i11, measuredWidth, measuredHeight2);
                paddingTop = i11 + measuredHeight2 + linearLayoutCompat$LayoutParams.bottomMargin;
            }
        }
    }
