...
class SuggestionsAdapter extends ResourceCursorAdapter implements View$OnClickListener {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (suggestionsAdapter$ChildViewCache.mText2 != null) {
            ...
            setViewText(suggestionsAdapter$ChildViewCache.mText2, stringOrNull);
        }
        if (suggestionsAdapter$ChildViewCache.mIcon1 != null) {
            setViewDrawable(suggestionsAdapter$ChildViewCache.mIcon1, getIcon1(cursor), 4);
        }
        if (suggestionsAdapter$ChildViewCache.mIcon2 != null) {
            setViewDrawable(suggestionsAdapter$ChildViewCache.mIcon2, getIcon2(cursor), 8);
        }
