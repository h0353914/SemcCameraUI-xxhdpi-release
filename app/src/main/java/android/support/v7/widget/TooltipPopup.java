...
class TooltipPopup {
    ...
    private void computePosition(View view, int i, int i2, boolean z, WindowManager$LayoutParams windowManager$LayoutParams) {
        int height;
        int i3;
        ...
        windowManager$LayoutParams.x = (this.mTmpAnchorPos[0] + i) - (appRootView.getWidth() / 2);
        ...
        if (z) {
            if (i4 >= 0) {
                windowManager$LayoutParams.y = i4;
                return;
            } else {
