...
public class LinearSmoothScroller extends RecyclerView$SmoothScroller {
    ...
    @Override // android.support.v7.widget.RecyclerView$SmoothScroller
    protected void onSeekTargetStep(int i, int i2, RecyclerView$State recyclerView$State, RecyclerView$SmoothScroller$Action recyclerView$SmoothScroller$Action) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
    ...
    public int calculateDyToMakeVisible(View view, int i) {
        ...
        return calculateDtToFit(layoutManager.getDecoratedTop(view) - recyclerView$LayoutParams.topMargin, layoutManager.getDecoratedBottom(view) + recyclerView$LayoutParams.bottomMargin, layoutManager.getPaddingTop(), layoutManager.getHeight() - layoutManager.getPaddingBottom(), i);
    }
    ...
    public int calculateDxToMakeVisible(View view, int i) {
        ...
        RecyclerView$LayoutParams recyclerView$LayoutParams = (RecyclerView$LayoutParams) view.getLayoutParams();
        return calculateDtToFit(layoutManager.getDecoratedLeft(view) - recyclerView$LayoutParams.leftMargin, layoutManager.getDecoratedRight(view) + recyclerView$LayoutParams.rightMargin, layoutManager.getPaddingLeft(), layoutManager.getWidth() - layoutManager.getPaddingRight(), i);
    }
}
