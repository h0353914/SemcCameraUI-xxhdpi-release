...
class AppCompatTextViewAutoSizeHelper {
    ...
    private boolean suggestedSizeFitsInSpace(int i, RectF rectF) {
        ...
        Layout$Alignment layout$Alignment = (Layout$Alignment) invokeAndReturnWithDefault(this.mTextView, "getLayoutAlignment", Layout$Alignment.ALIGN_NORMAL);
        if (Build$VERSION.SDK_INT >= 23) {
            staticLayoutCreateStaticLayoutForMeasuringPre23 = createStaticLayoutForMeasuring(text, layout$Alignment, Math.round(rectF.right), maxLines);
        } else {
            staticLayoutCreateStaticLayoutForMeasuringPre23 = createStaticLayoutForMeasuringPre23(text, layout$Alignment, Math.round(rectF.right));
        }
    ...
    private StaticLayout createStaticLayoutForMeasuringPre23(CharSequence charSequence, Layout$Alignment layout$Alignment, int i) {
        ...
        return new StaticLayout(charSequence, this.mTempTextPaint, i, layout$Alignment, fFloatValue, fFloatValue2, zBooleanValue);
    }
