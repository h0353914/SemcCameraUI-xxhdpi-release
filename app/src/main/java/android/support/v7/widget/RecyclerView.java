...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    static /* synthetic */ void access$000(RecyclerView recyclerView, View view, int i, ViewGroup$LayoutParams viewGroup$LayoutParams) {
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            ...
            String string = typedArrayObtainStyledAttributes2.getString(R$styleable.RecyclerView_layoutManager);
            if (typedArrayObtainStyledAttributes2.getInt(R$styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = typedArrayObtainStyledAttributes2.getBoolean(R$styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) typedArrayObtainStyledAttributes2.getDrawable(R$styleable.RecyclerView_fastScrollVerticalThumbDrawable), typedArrayObtainStyledAttributes2.getDrawable(R$styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) typedArrayObtainStyledAttributes2.getDrawable(R$styleable.RecyclerView_fastScrollHorizontalThumbDrawable), typedArrayObtainStyledAttributes2.getDrawable(R$styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    private void createLayoutManager(Context context, String str, AttributeSet attributeSet, int i, int i2) {
        ...
        if (str != null) {
            ...
            try {
                ...
                Class<? extends U> clsAsSubclass = classLoader.loadClass(fullClassName).asSubclass(RecyclerView$LayoutManager.class);
                Object[] objArr = null;
                try {
    ...
    public void swapAdapter(@Nullable RecyclerView$Adapter recyclerView$Adapter, boolean z) {
        setLayoutFrozen(false);
        setAdapterInternal(recyclerView$Adapter, true, z);
    ...
    private void setAdapterInternal(@Nullable RecyclerView$Adapter recyclerView$Adapter, boolean z, boolean z2) {
        ...
        if (this.mLayout != null) {
            this.mLayout.onAdapterChanged(recyclerView$Adapter2, this.mAdapter);
        }
    ...
    public void setLayoutManager(@Nullable RecyclerView$LayoutManager recyclerView$LayoutManager) {
        ...
        if (recyclerView$LayoutManager != null) {
            if (recyclerView$LayoutManager.mRecyclerView != null) {
                throw new IllegalArgumentException("LayoutManager " + recyclerView$LayoutManager + " is already attached to a RecyclerView:" + recyclerView$LayoutManager.mRecyclerView.exceptionLabel());
            }
    ...
    */
    ...
    private boolean dispatchOnItemTouch(MotionEvent motionEvent) {
        ...
        if (action != 0) {
            ...
            for (int i = 0; i < size; i++) {
                RecyclerView$OnItemTouchListener recyclerView$OnItemTouchListener = this.mOnItemTouchListeners.get(i);
                if (recyclerView$OnItemTouchListener.onInterceptTouchEvent(this, motionEvent)) {
                    this.mActiveOnItemTouchListener = recyclerView$OnItemTouchListener;
                    return true;
                }
            }
    ...
    */
    ...
    private void saveFocusInfo() {
        ...
        if (this.mDataSetHasChangedAfterLayout) {
            ...
            adapterPosition = recyclerView$ViewHolderFindContainingViewHolder.isRemoved() ? recyclerView$ViewHolderFindContainingViewHolder.mOldPosition : recyclerView$ViewHolderFindContainingViewHolder.getAdapterPosition();
        }
        recyclerView$State.mFocusedItemPosition = adapterPosition;
    ...
    final void fillRemainingScrollValues(RecyclerView$State recyclerView$State) {
        if (getScrollState() == 2) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childViewHolderInt != recyclerView$ViewHolder && getChangedHolderKey(childViewHolderInt) == j) {
                if (this.mAdapter != null && this.mAdapter.hasStableIds()) {
                    throw new IllegalStateException("Two different ViewHolders have the same stable ID. Stable IDs in your adapter MUST BE unique and SHOULD NOT change.\n ViewHolder 1:" + childViewHolderInt + " \n View Holder 2:" + recyclerView$ViewHolder + exceptionLabel());
                }
                throw new IllegalStateException("Two different ViewHolders have the same change ID. This might happen due to inconsistent Adapter update events or if the LayoutManager lays out the same View multiple times.\n ViewHolder 1:" + childViewHolderInt + " \n View Holder 2:" + recyclerView$ViewHolder + exceptionLabel());
            }
        }
        Log.e("RecyclerView", "Problem while matching changed view holders with the newones. The pre-layout information for the change holder " + recyclerView$ViewHolder2 + " cannot be found but it is necessary for " + recyclerView$ViewHolder + exceptionLabel());
    }

    void recordAnimationInfoIfBouncedHiddenView(RecyclerView$ViewHolder recyclerView$ViewHolder, RecyclerView$ItemAnimator$ItemHolderInfo recyclerView$ItemAnimator$ItemHolderInfo) {
    ...
    long getChangedHolderKey(RecyclerView$ViewHolder recyclerView$ViewHolder) {
        return this.mAdapter.hasStableIds() ? recyclerView$ViewHolder.getItemId() : recyclerView$ViewHolder.mPosition;
    }

    void animateAppearance(@NonNull RecyclerView$ViewHolder recyclerView$ViewHolder, @Nullable RecyclerView$ItemAnimator$ItemHolderInfo recyclerView$ItemAnimator$ItemHolderInfo, @NonNull RecyclerView$ItemAnimator$ItemHolderInfo recyclerView$ItemAnimator$ItemHolderInfo2) {
    ...
    void animateDisappearance(@NonNull RecyclerView$ViewHolder recyclerView$ViewHolder, @NonNull RecyclerView$ItemAnimator$ItemHolderInfo recyclerView$ItemAnimator$ItemHolderInfo, @Nullable RecyclerView$ItemAnimator$ItemHolderInfo recyclerView$ItemAnimator$ItemHolderInfo2) {
    ...
    private void animateChange(@NonNull RecyclerView$ViewHolder recyclerView$ViewHolder, @NonNull RecyclerView$ViewHolder recyclerView$ViewHolder2, @NonNull RecyclerView$ItemAnimator$ItemHolderInfo recyclerView$ItemAnimator$ItemHolderInfo, @NonNull RecyclerView$ItemAnimator$ItemHolderInfo recyclerView$ItemAnimator$ItemHolderInfo2, boolean z, boolean z2) {
        recyclerView$ViewHolder.setIsRecyclable(false);
        if (z) {
            addAnimatingView(recyclerView$ViewHolder);
        }
    ...
    protected ViewGroup$LayoutParams generateLayoutParams(ViewGroup$LayoutParams viewGroup$LayoutParams) {
        ...
        return this.mLayout.generateLayoutParams(viewGroup$LayoutParams);
    }
    ...
    void offsetPositionRecordsForMove(int i, int i2) {
        ...
        for (int i6 = 0; i6 < unfilteredChildCount; i6++) {
            RecyclerView$ViewHolder childViewHolderInt = getChildViewHolderInt(this.mChildHelper.getUnfilteredChildAt(i6));
    ...
    boolean canReuseUpdatedViewHolder(RecyclerView$ViewHolder recyclerView$ViewHolder) {
    ...
    static RecyclerView$ViewHolder getChildViewHolderInt(View view) {
        if (view == null) {
            return null;
        }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    RecyclerView$ViewHolder findViewHolderForPosition(int i, boolean z) {
        int unfilteredChildCount = this.mChildHelper.getUnfilteredChildCount();
        RecyclerView$ViewHolder recyclerView$ViewHolder = null;
        for (int i2 = 0; i2 < unfilteredChildCount; i2++) {
            RecyclerView$ViewHolder childViewHolderInt = getChildViewHolderInt(this.mChildHelper.getUnfilteredChildAt(i2));
    ...
    static void getDecoratedBoundsWithMarginsInt(View view, Rect rect) {
        ...
        rect.set((view.getLeft() - rect2.left) - recyclerView$LayoutParams.leftMargin, (view.getTop() - rect2.top) - recyclerView$LayoutParams.topMargin, view.getRight() + rect2.right + recyclerView$LayoutParams.rightMargin, view.getBottom() + rect2.bottom + recyclerView$LayoutParams.bottomMargin);
    }
    ...
    static void clearNestedRecyclerViewIfNotNested(@NonNull RecyclerView$ViewHolder recyclerView$ViewHolder) {
        if (recyclerView$ViewHolder.mNestedRecyclerView != null) {
            RecyclerView recyclerView = recyclerView$ViewHolder.mNestedRecyclerView.get();
    ...
    @VisibleForTesting
    boolean setChildImportantForAccessibilityInternal(RecyclerView$ViewHolder recyclerView$ViewHolder, int i) {
        if (isComputingLayout()) {
    ...
    int getAdapterPositionFor(RecyclerView$ViewHolder recyclerView$ViewHolder) {
