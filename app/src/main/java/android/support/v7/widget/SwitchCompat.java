...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mThumbDrawable = tintTypedArrayObtainStyledAttributes.getDrawable(R$styleable.SwitchCompat_android_thumb);
        if (this.mThumbDrawable != null) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = tintTypedArrayObtainStyledAttributes.getDrawable(R$styleable.SwitchCompat_track);
