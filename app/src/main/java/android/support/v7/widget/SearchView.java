...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mOnClickListener = new SearchView$5(this);
        this.mTextKeyListener = new SearchView$6(this);
        this.mOnEditorActionListener = new SearchView$7(this);
        this.mOnItemClickListener = new SearchView$8(this);
        this.mOnItemSelectedListener = new SearchView$9(this);
