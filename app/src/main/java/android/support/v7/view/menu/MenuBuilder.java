...
public class MenuBuilder implements SupportMenu {
    ...
    void findItemsWithShortcutForKey(List<MenuItemImpl> list, int i, KeyEvent keyEvent) {
        ...
        if (keyEvent.getKeyData(keyCharacterMap$KeyData) || i == 67) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (((modifiers & 69647) == ((zIsQwertyMode ? menuItemImpl.getAlphabeticModifiers() : menuItemImpl.getNumericModifiers()) & 69647)) && alphabeticShortcut != 0 && ((alphabeticShortcut == keyCharacterMap$KeyData.meta[0] || alphabeticShortcut == keyCharacterMap$KeyData.meta[2] || (zIsQwertyMode && alphabeticShortcut == '\b' && i == 67)) && menuItemImpl.isEnabled())) {
    ...
    MenuItemImpl findItemWithShortcutForKey(int i, KeyEvent keyEvent) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if ((numericShortcut == keyCharacterMap$KeyData.meta[0] && (metaState & 2) == 0) || ((numericShortcut == keyCharacterMap$KeyData.meta[2] && (metaState & 2) != 0) || (zIsQwertyMode && numericShortcut == '\b' && i == 67))) {
                return menuItemImpl;
            }
        }
        return null;
