...
public class MenuItemWrapperICS extends BaseMenuWrapper<SupportMenuItem> implements MenuItem {
    ...
    public MenuItem setOnMenuItemClickListener(MenuItem$OnMenuItemClickListener menuItem$OnMenuItemClickListener) {
        ((SupportMenuItem) this.mWrappedObject).setOnMenuItemClickListener(menuItem$OnMenuItemClickListener != null ? new MenuItemWrapperICS$OnMenuItemClickListenerWrapper(this, menuItem$OnMenuItemClickListener) : null);
        return this;
    }
    ...
    public MenuItem setOnActionExpandListener(MenuItem$OnActionExpandListener menuItem$OnActionExpandListener) {
        ((SupportMenuItem) this.mWrappedObject).setOnActionExpandListener(menuItem$OnActionExpandListener != null ? new MenuItemWrapperICS$OnActionExpandListenerWrapper(this, menuItem$OnActionExpandListener) : null);
        return this;
    }
    ...
    public MenuItem setIconTintMode(PorterDuff$Mode porterDuff$Mode) {
        ((SupportMenuItem) this.mWrappedObject).setIconTintMode(porterDuff$Mode);
        return this;
    }
