...
public class AnimatorInflaterCompat {
    ...
    public static Animator loadAnimator(Context context, Resources resources, Resources$Theme resources$Theme, @AnimatorRes int i, float f) throws Throwable {
        ...
        try {
            ...
            resources$NotFoundException2.initCause(e);
        ...
        while (true) {
            ...
            if (xmlPullParser.getName().equals("keyframe")) {
                if (iInferValueTypeOfKeyframe == 4) {
                    iInferValueTypeOfKeyframe = inferValueTypeOfKeyframe(resources, resources$Theme, Xml.asAttributeSet(xmlPullParser), xmlPullParser);
                }
                Keyframe keyframeLoadKeyframe = loadKeyframe(context, resources, resources$Theme, Xml.asAttributeSet(xmlPullParser), iInferValueTypeOfKeyframe, xmlPullParser);
            ...
            if (i != 3) {
                switch (i) {
                    case 0:
                        ...
                        break;
                    case 1:
                        keyframeOfInt = Keyframe.ofInt(namedFloat, TypedArrayUtils.getNamedInt(typedArrayObtainAttributes, xmlPullParser, "value", 0, 0));
                        break;
                    default:
                        keyframeOfInt = null;
                        break;
