...
public class ViewCompat {
    ...
    public static void setOnApplyWindowInsetsListener(@NonNull View view, OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        if (Build$VERSION.SDK_INT >= 21) {
            if (onApplyWindowInsetsListener == null) {
                ...
                view.setOnApplyWindowInsetsListener(new ViewCompat$1(onApplyWindowInsetsListener));
            }
        }
    }
    ...
    public static boolean startDragAndDrop(@NonNull View view, ClipData clipData, View$DragShadowBuilder view$DragShadowBuilder, Object obj, int i) {
        ...
        return view.startDrag(clipData, view$DragShadowBuilder, obj, i);
    }
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View view, @NonNull ViewCompat$OnUnhandledKeyEventListenerCompat viewCompat$OnUnhandledKeyEventListenerCompat) {
        if (Build$VERSION.SDK_INT >= 28) {
            ...
            ViewCompat$OnUnhandledKeyEventListenerWrapper viewCompat$OnUnhandledKeyEventListenerWrapper = new ViewCompat$OnUnhandledKeyEventListenerWrapper(viewCompat$OnUnhandledKeyEventListenerCompat);
            arrayMap.put(viewCompat$OnUnhandledKeyEventListenerCompat, viewCompat$OnUnhandledKeyEventListenerWrapper);
            view.addOnUnhandledKeyEventListener(viewCompat$OnUnhandledKeyEventListenerWrapper);
            return;
        }
    ...
    public static void removeOnUnhandledKeyEventListener(@NonNull View view, @NonNull ViewCompat$OnUnhandledKeyEventListenerCompat viewCompat$OnUnhandledKeyEventListenerCompat) {
        ...
        if (Build$VERSION.SDK_INT >= 28) {
            ...
            if (map == null || (view$OnUnhandledKeyEventListener = (View$OnUnhandledKeyEventListener) map.get(viewCompat$OnUnhandledKeyEventListenerCompat)) == null) {
                return;
            }
