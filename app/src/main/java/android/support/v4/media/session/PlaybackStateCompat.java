...
public final class PlaybackStateCompat implements Parcelable {
    ...
    PlaybackStateCompat(int i, long j, long j2, float f, long j3, int i2, CharSequence charSequence, long j4, List<PlaybackStateCompat$CustomAction> list, long j5, Bundle bundle) {
        this.mState = i;
        this.mPosition = j;
    ...
    public static PlaybackStateCompat fromPlaybackState(Object obj) {
        ...
        if (customActions != null) {
            ...
            while (it.hasNext()) {
                arrayList2.add(PlaybackStateCompat$CustomAction.fromCustomAction(it.next()));
            }
    ...
    public Object getPlaybackState() {
        if (this.mStateObj == null && Build$VERSION.SDK_INT >= 21) {
            ...
            if (this.mCustomActions != null) {
                ...
                Iterator<PlaybackStateCompat$CustomAction> it = this.mCustomActions.iterator();
                while (it.hasNext()) {
