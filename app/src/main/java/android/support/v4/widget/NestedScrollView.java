...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent2, NestedScrollingChild2, ScrollingView {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.mFillViewport && View$MeasureSpec.getMode(i2) != 0 && getChildCount() > 0) {
            ...
            if (measuredHeight < measuredHeight2) {
                childAt.measure(getChildMeasureSpec(i, getPaddingLeft() + getPaddingRight() + frameLayout$LayoutParams.leftMargin + frameLayout$LayoutParams.rightMargin, frameLayout$LayoutParams.width), View$MeasureSpec.makeMeasureSpec(measuredHeight2, 1073741824));
            }
        }
    }
    ...
    */
    ...
    protected void measureChildWithMargins(View view, int i, int i2, int i3, int i4) {
        ...
        view.measure(getChildMeasureSpec(i, getPaddingLeft() + getPaddingRight() + viewGroup$MarginLayoutParams.leftMargin + viewGroup$MarginLayoutParams.rightMargin + i2, viewGroup$MarginLayoutParams.width), View$MeasureSpec.makeMeasureSpec(viewGroup$MarginLayoutParams.topMargin + viewGroup$MarginLayoutParams.bottomMargin, 0));
    }
    ...
    protected int computeScrollDeltaToGetChildRectOnScreen(Rect rect) {
        ...
        View childAt = getChildAt(0);
        FrameLayout$LayoutParams frameLayout$LayoutParams = (FrameLayout$LayoutParams) childAt.getLayoutParams();
        int i4 = rect.bottom < (childAt.getHeight() + frameLayout$LayoutParams.topMargin) + frameLayout$LayoutParams.bottomMargin ? i3 - verticalFadingEdgeLength : i3;
        if (rect.bottom > i4 && rect.top > scrollY) {
            ...
            return Math.min(i2, (childAt.getBottom() + frameLayout$LayoutParams.bottomMargin) - i3);
        }
