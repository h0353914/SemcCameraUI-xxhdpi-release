...
class WrappedDrawableApi14 extends Drawable implements Drawable$Callback, WrappedDrawable, TintAwareDrawable {
    ...
    WrappedDrawableApi14(@NonNull WrappedDrawableApi14$DrawableWrapperState wrappedDrawableApi14$DrawableWrapperState, @Nullable Resources resources) {
        this.mState = wrappedDrawableApi14$DrawableWrapperState;
    ...
    private boolean updateTint(int[] iArr) {
        ...
        PorterDuff$Mode porterDuff$Mode = this.mState.mTintMode;
