...
public class Fragment implements ComponentCallbacks, View$OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner {
    ...
    public void setInitialSavedState(@Nullable Fragment$SavedState fragment$SavedState) {
        ...
        this.mSavedFragmentState = (fragment$SavedState == null || fragment$SavedState.mState == null) ? null : fragment$SavedState.mState;
    }
    ...
    public void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenu$ContextMenuInfo contextMenu$ContextMenuInfo) {
        getActivity().onCreateContextMenu(contextMenu, view, contextMenu$ContextMenuInfo);
    }
    ...
    void performCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.mViewLifecycleOwner = new Fragment$3(this);
    ...
    void setOnStartEnterTransitionListener(Fragment$OnStartEnterTransitionListener fragment$OnStartEnterTransitionListener) {
        ensureAnimationInfo();
        if (fragment$OnStartEnterTransitionListener == this.mAnimationInfo.mStartEnterTransitionListener) {
            return;
        }
        if (fragment$OnStartEnterTransitionListener != null && this.mAnimationInfo.mStartEnterTransitionListener != null) {
            throw new IllegalStateException("Trying to set a replacement startPostponedEnterTransition on " + this);
        }
        if (this.mAnimationInfo.mEnterTransitionPostponed) {
            this.mAnimationInfo.mStartEnterTransitionListener = fragment$OnStartEnterTransitionListener;
        }
        if (fragment$OnStartEnterTransitionListener != null) {
