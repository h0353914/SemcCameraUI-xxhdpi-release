...
class NotificationCompatJellybean {
    ...
    public static Bundle writeActionAndGetExtras(Notification$Builder notification$Builder, NotificationCompat$Action notificationCompat$Action) {
        notification$Builder.addAction(notificationCompat$Action.getIcon(), notificationCompat$Action.getTitle(), notificationCompat$Action.getActionIntent());
    ...
    static Bundle getBundleForAction(NotificationCompat$Action notificationCompat$Action) {
        ...
        bundle2.putInt("icon", notificationCompat$Action.getIcon());
