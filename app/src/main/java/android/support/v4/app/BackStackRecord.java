...
final class BackStackRecord extends FragmentTransaction implements FragmentManager$BackStackEntry, FragmentManagerImpl$OpGenerator {
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (backStackRecord$Op.cmd) {
                ...
                case 9:
                    ...
                    break;
                default:
                    str2 = "cmd=" + backStackRecord$Op.cmd;
                    break;
            }
            printWriter.print(str);
    ...
    void addOp(BackStackRecord$Op backStackRecord$Op) {
    ...
    private void doAddOp(int i, Fragment fragment, @Nullable String str, int i2) {
        ...
        addOp(new BackStackRecord$Op(i2, fragment));
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new BackStackRecord$Op(3, fragment));
        return this;
    }

    @Override // android.support.v4.app.FragmentTransaction
    public FragmentTransaction hide(Fragment fragment) {
        addOp(new BackStackRecord$Op(4, fragment));
        return this;
    }

    @Override // android.support.v4.app.FragmentTransaction
    public FragmentTransaction show(Fragment fragment) {
        addOp(new BackStackRecord$Op(5, fragment));
        return this;
    }

    @Override // android.support.v4.app.FragmentTransaction
    public FragmentTransaction detach(Fragment fragment) {
        addOp(new BackStackRecord$Op(6, fragment));
        return this;
    }

    @Override // android.support.v4.app.FragmentTransaction
    public FragmentTransaction attach(Fragment fragment) {
        addOp(new BackStackRecord$Op(7, fragment));
        return this;
    }

    @Override // android.support.v4.app.FragmentTransaction
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        addOp(new BackStackRecord$Op(8, fragment));
        return this;
    }
    ...
    void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                BackStackRecord$Op backStackRecord$Op = this.mOps.get(i2);
                if (backStackRecord$Op.fragment != null) {
                    backStackRecord$Op.fragment.mBackStackNesting += i;
                    if (FragmentManagerImpl.DEBUG) {
    ...
    boolean interactsWith(int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            BackStackRecord$Op backStackRecord$Op = this.mOps.get(i2);
            int i3 = backStackRecord$Op.fragment != null ? backStackRecord$Op.fragment.mContainerId : 0;
            if (i3 != 0 && i3 == i) {
                return true;
            }
        }
    ...
    boolean interactsWith(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            BackStackRecord$Op backStackRecord$Op = this.mOps.get(i4);
            int i5 = backStackRecord$Op.fragment != null ? backStackRecord$Op.fragment.mContainerId : 0;
            if (i5 != 0 && i5 != i3) {
                for (int i6 = i; i6 < i2; i6++) {
                    BackStackRecord backStackRecord = arrayList.get(i6);
                    int size2 = backStackRecord.mOps.size();
                    for (int i7 = 0; i7 < size2; i7++) {
                        BackStackRecord$Op backStackRecord$Op2 = backStackRecord.mOps.get(i7);
                        if ((backStackRecord$Op2.fragment != null ? backStackRecord$Op2.fragment.mContainerId : 0) == i5) {
                            return true;
                        }
                    }
                }
    ...
    void executeOps() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (!this.mReorderingAllowed && backStackRecord$Op.cmd != 1 && fragment != null) {
    ...
    void executePopOps(boolean z) {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            BackStackRecord$Op backStackRecord$Op = this.mOps.get(size);
            Fragment fragment = backStackRecord$Op.fragment;
            if (fragment != null) {
                fragment.setNextTransition(FragmentManagerImpl.reverseTransit(this.mTransition), this.mTransitionStyle);
            }
            int i = backStackRecord$Op.cmd;
            if (i == 1) {
            ...
            if (!this.mReorderingAllowed && backStackRecord$Op.cmd != 3 && fragment != null) {
                this.mManager.moveFragmentToExpectedState(fragment);
            }
        }
    ...
    Fragment expandOps(ArrayList<Fragment> arrayList, Fragment fragment) {
        ...
        while (i < this.mOps.size()) {
            ...
            switch (backStackRecord$Op.cmd) {
                case 1:
                case 7:
                    arrayList.add(backStackRecord$Op.fragment);
                    break;
                case 2:
                    Fragment fragment3 = backStackRecord$Op.fragment;
                        ...
                        if (fragment5.mContainerId == i2) {
                            if (fragment5 == fragment3) {
                                ...
                                if (fragment5 == fragment4) {
                                    this.mOps.add(i3, new BackStackRecord$Op(9, fragment5));
                                    i3++;
                                    fragment4 = null;
                                }
                                BackStackRecord$Op backStackRecord$Op2 = new BackStackRecord$Op(3, fragment5);
                                ...
                                this.mOps.add(i3, backStackRecord$Op2);
                ...
                case 3:
                case 6:
                    arrayList.remove(backStackRecord$Op.fragment);
                    if (backStackRecord$Op.fragment == fragment2) {
                ...
                case 8:
                    ...
                    i++;
                    fragment2 = backStackRecord$Op.fragment;
                    break;
            }
            i++;
        }
    ...
    */
            ...
            if (i2 == 1) {
                ...
                switch (i2) {
                    ...
                    case 8:
                        ...
                        break;
                    case 9:
                        fragment = backStackRecord$Op.fragment;
                        break;
                }
            }
        }
    ...
    void setOnStartPostponedListener(Fragment$OnStartEnterTransitionListener fragment$OnStartEnterTransitionListener) {
        for (int i = 0; i < this.mOps.size(); i++) {
            BackStackRecord$Op backStackRecord$Op = this.mOps.get(i);
            if (isFragmentPostponed(backStackRecord$Op)) {
                backStackRecord$Op.fragment.setOnStartEnterTransitionListener(fragment$OnStartEnterTransitionListener);
            }
        }
    }

    private static boolean isFragmentPostponed(BackStackRecord$Op backStackRecord$Op) {
        Fragment fragment = backStackRecord$Op.fragment;
