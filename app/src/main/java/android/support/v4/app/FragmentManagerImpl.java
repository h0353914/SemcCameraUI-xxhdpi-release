...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater$Factory2 {
    ...
    static boolean modifiesAlpha(FragmentManagerImpl$AnimationOrAnimator fragmentManagerImpl$AnimationOrAnimator) {
        if (fragmentManagerImpl$AnimationOrAnimator.animation instanceof AlphaAnimation) {
            return true;
        }
        if (fragmentManagerImpl$AnimationOrAnimator.animation instanceof AnimationSet) {
            List<Animation> animations = ((AnimationSet) fragmentManagerImpl$AnimationOrAnimator.animation).getAnimations();
        ...
        return modifiesAlpha(fragmentManagerImpl$AnimationOrAnimator.animator);
    }
    ...
    static boolean shouldRunOnHWLayer(View view, FragmentManagerImpl$AnimationOrAnimator fragmentManagerImpl$AnimationOrAnimator) {
        return view != null && fragmentManagerImpl$AnimationOrAnimator != null && Build$VERSION.SDK_INT >= 19 && view.getLayerType() == 0 && ViewCompat.hasOverlappingRendering(view) && modifiesAlpha(fragmentManagerImpl$AnimationOrAnimator);
    }
    ...
    public void popBackStack(@Nullable String str, int i) {
        enqueueAction(new FragmentManagerImpl$PopBackStackState(this, str, -1, i), false);
    }
    ...
    public void popBackStack(int i, int i2) {
        ...
        enqueueAction(new FragmentManagerImpl$PopBackStackState(this, null, i, i2), false);
    }
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        if (this.mPendingActions != null && (size = this.mPendingActions.size()) > 0) {
            ...
            for (int i6 = 0; i6 < size; i6++) {
                Object obj2 = (FragmentManagerImpl$OpGenerator) this.mPendingActions.get(i6);
                printWriter.print(str);
                printWriter.print("  #");
    ...
    static FragmentManagerImpl$AnimationOrAnimator makeOpenCloseAnimation(Context context, float f, float f2, float f3, float f4) {
        ...
        return new FragmentManagerImpl$AnimationOrAnimator(animationSet);
    }

    static FragmentManagerImpl$AnimationOrAnimator makeFadeAnimation(Context context, float f, float f2) {
        AlphaAnimation alphaAnimation = new AlphaAnimation(f, f2);
        alphaAnimation.setInterpolator(DECELERATE_CUBIC);
        alphaAnimation.setDuration(220L);
        return new FragmentManagerImpl$AnimationOrAnimator(alphaAnimation);
    }

    FragmentManagerImpl$AnimationOrAnimator loadAnimation(Fragment fragment, int i, boolean z, int i2) {
        int iTransitToStyleIndex;
        int nextAnim = fragment.getNextAnim();
        Animation animationOnCreateAnimation = fragment.onCreateAnimation(i, z, nextAnim);
        if (animationOnCreateAnimation != null) {
            return new FragmentManagerImpl$AnimationOrAnimator(animationOnCreateAnimation);
        }
        Animator animatorOnCreateAnimator = fragment.onCreateAnimator(i, z, nextAnim);
        if (animatorOnCreateAnimator != null) {
            return new FragmentManagerImpl$AnimationOrAnimator(animatorOnCreateAnimator);
        }
        if (nextAnim != 0) {
            ...
            if (zEquals) {
                try {
                    ...
                    if (animationLoadAnimation != null) {
                        return new FragmentManagerImpl$AnimationOrAnimator(animationLoadAnimation);
                    }
                    z2 = true;
            ...
            if (!z2) {
                try {
                    ...
                    if (animatorLoadAnimator != null) {
                        return new FragmentManagerImpl$AnimationOrAnimator(animatorLoadAnimator);
                    }
                    ...
                    if (animationLoadAnimation2 != null) {
                        return new FragmentManagerImpl$AnimationOrAnimator(animationLoadAnimation2);
                    }
                }
            }
        }
    ...
    private static void setHWLayerAnimListenerIfAlpha(View view, FragmentManagerImpl$AnimationOrAnimator fragmentManagerImpl$AnimationOrAnimator) {
        if (view == null || fragmentManagerImpl$AnimationOrAnimator == null || !shouldRunOnHWLayer(view, fragmentManagerImpl$AnimationOrAnimator)) {
            return;
        }
        if (fragmentManagerImpl$AnimationOrAnimator.animator != null) {
            fragmentManagerImpl$AnimationOrAnimator.animator.addListener(new FragmentManagerImpl$AnimatorOnHWLayerIfNeededListener(view));
            return;
        }
        Animation$AnimationListener animationListener = getAnimationListener(fragmentManagerImpl$AnimationOrAnimator.animation);
        view.setLayerType(2, null);
        fragmentManagerImpl$AnimationOrAnimator.animation.setAnimationListener(new FragmentManagerImpl$AnimateOnHWLayerIfNeededListener(view, animationListener));
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:212:0x043b A[FALL_THROUGH, PHI: r11
      0x043b: PHI (r11v2 int) = (r11v1 int), (r11v1 int), (r11v1 int), (r11v1 int), (r11v1 int), (r11v1 int), (r11v1 int), (r11v3 int), (r11v3 int) binds: [B:139:0x02f0, B:141:0x02f4, B:184:0x03c5, B:206:0x0426, B:210:0x0430, B:209:0x042c, B:41:0x0068, B:133:0x02c6, B:137:0x02e2] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
                    ...
                    case 2:
                        if (i6 < 2) {
                            ...
                            if (fragment.mView != null && fragment.mContainer != null) {
                                ...
                                FragmentManagerImpl$AnimationOrAnimator fragmentManagerImpl$AnimationOrAnimatorLoadAnimation = (this.mCurState <= 0 || this.mDestroyed || fragment.mView.getVisibility() != 0 || fragment.mPostponedAlpha < 0.0f) ? null : loadAnimation(fragment, i2, false, i3);
                                fragment.mPostponedAlpha = 0.0f;
                                if (fragmentManagerImpl$AnimationOrAnimatorLoadAnimation != null) {
                                    animateRemoveFragment(fragment, fragmentManagerImpl$AnimationOrAnimatorLoadAnimation, i6);
                                }
    ...
    private void animateRemoveFragment(@NonNull Fragment fragment, @NonNull FragmentManagerImpl$AnimationOrAnimator fragmentManagerImpl$AnimationOrAnimator, int i) {
        View view = fragment.mView;
        ViewGroup viewGroup = fragment.mContainer;
        viewGroup.startViewTransition(view);
        fragment.setStateAfterAnimating(i);
        if (fragmentManagerImpl$AnimationOrAnimator.animation != null) {
            FragmentManagerImpl$EndViewTransitionAnimator fragmentManagerImpl$EndViewTransitionAnimator = new FragmentManagerImpl$EndViewTransitionAnimator(fragmentManagerImpl$AnimationOrAnimator.animation, viewGroup, view);
            fragment.setAnimatingAway(fragment.mView);
            fragmentManagerImpl$EndViewTransitionAnimator.setAnimationListener(new FragmentManagerImpl$2(this, getAnimationListener(fragmentManagerImpl$EndViewTransitionAnimator), viewGroup, fragment));
            setHWLayerAnimListenerIfAlpha(view, fragmentManagerImpl$AnimationOrAnimator);
            fragment.mView.startAnimation(fragmentManagerImpl$EndViewTransitionAnimator);
            return;
        }
        Animator animator = fragmentManagerImpl$AnimationOrAnimator.animator;
        fragment.setAnimator(fragmentManagerImpl$AnimationOrAnimator.animator);
        animator.addListener(new FragmentManagerImpl$3(this, viewGroup, view, fragment));
        animator.setTarget(fragment.mView);
        setHWLayerAnimListenerIfAlpha(fragment.mView, fragmentManagerImpl$AnimationOrAnimator);
        animator.start();
    }
    ...
    void completeShowHideFragment(Fragment fragment) {
        if (fragment.mView != null) {
            FragmentManagerImpl$AnimationOrAnimator fragmentManagerImpl$AnimationOrAnimatorLoadAnimation = loadAnimation(fragment, fragment.getNextTransition(), !fragment.mHidden, fragment.getNextTransitionStyle());
            if (fragmentManagerImpl$AnimationOrAnimatorLoadAnimation != null && fragmentManagerImpl$AnimationOrAnimatorLoadAnimation.animator != null) {
                fragmentManagerImpl$AnimationOrAnimatorLoadAnimation.animator.setTarget(fragment.mView);
                if (fragment.mHidden) {
                    if (fragment.isHideReplaced()) {
                        ...
                        View view = fragment.mView;
                        viewGroup.startViewTransition(view);
                        fragmentManagerImpl$AnimationOrAnimatorLoadAnimation.animator.addListener(new FragmentManagerImpl$4(this, viewGroup, view, fragment));
                    }
                } else {
                    fragment.mView.setVisibility(0);
                }
                setHWLayerAnimListenerIfAlpha(fragment.mView, fragmentManagerImpl$AnimationOrAnimatorLoadAnimation);
                fragmentManagerImpl$AnimationOrAnimatorLoadAnimation.animator.start();
            } else {
                if (fragmentManagerImpl$AnimationOrAnimatorLoadAnimation != null) {
                    setHWLayerAnimListenerIfAlpha(fragment.mView, fragmentManagerImpl$AnimationOrAnimatorLoadAnimation);
                    fragment.mView.startAnimation(fragmentManagerImpl$AnimationOrAnimatorLoadAnimation.animation);
                    fragmentManagerImpl$AnimationOrAnimatorLoadAnimation.animation.start();
                }
    ...
    void moveFragmentToExpectedState(Fragment fragment) {
        ...
        if (fragment.mView != null) {
            ...
            if (fragment.mIsNewlyAdded && fragment.mContainer != null) {
                ...
                FragmentManagerImpl$AnimationOrAnimator fragmentManagerImpl$AnimationOrAnimatorLoadAnimation = loadAnimation(fragment, fragment.getNextTransition(), true, fragment.getNextTransitionStyle());
                if (fragmentManagerImpl$AnimationOrAnimatorLoadAnimation != null) {
                    setHWLayerAnimListenerIfAlpha(fragment.mView, fragmentManagerImpl$AnimationOrAnimatorLoadAnimation);
                    if (fragmentManagerImpl$AnimationOrAnimatorLoadAnimation.animation != null) {
                        fragment.mView.startAnimation(fragmentManagerImpl$AnimationOrAnimatorLoadAnimation.animation);
                    } else {
                        fragmentManagerImpl$AnimationOrAnimatorLoadAnimation.animator.setTarget(fragment.mView);
                        fragmentManagerImpl$AnimationOrAnimatorLoadAnimation.animator.start();
    ...
    public void enqueueAction(FragmentManagerImpl$OpGenerator fragmentManagerImpl$OpGenerator, boolean z) {
        if (!z) {
            checkStateLoss();
        }
        synchronized (this) {
    ...
    public void execSingleAction(FragmentManagerImpl$OpGenerator fragmentManagerImpl$OpGenerator, boolean z) {
    ...
    private void executePostponedTransaction(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2) {
        ...
        int i = 0;
        while (i < size) {
            FragmentManagerImpl$StartEnterTransitionListener fragmentManagerImpl$StartEnterTransitionListener = this.mPostponedTransactions.get(i);
            if (arrayList != null && !fragmentManagerImpl$StartEnterTransitionListener.mIsBack && (iIndexOf2 = arrayList.indexOf(fragmentManagerImpl$StartEnterTransitionListener.mRecord)) != -1 && arrayList2.get(iIndexOf2).booleanValue()) {
                fragmentManagerImpl$StartEnterTransitionListener.cancelTransaction();
            } else if (fragmentManagerImpl$StartEnterTransitionListener.isReady() || (arrayList != null && fragmentManagerImpl$StartEnterTransitionListener.mRecord.interactsWith(arrayList, 0, arrayList.size()))) {
                this.mPostponedTransactions.remove(i);
                i--;
                size--;
                if (arrayList != null && !fragmentManagerImpl$StartEnterTransitionListener.mIsBack && (iIndexOf = arrayList.indexOf(fragmentManagerImpl$StartEnterTransitionListener.mRecord)) != -1 && arrayList2.get(iIndexOf).booleanValue()) {
                    fragmentManagerImpl$StartEnterTransitionListener.cancelTransaction();
                } else {
    ...
    private int postponePostponableTransactions(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int i, int i2, ArraySet<Fragment> arraySet) {
        ...
        for (int i4 = i2 - 1; i4 >= i; i4--) {
            ...
            if (backStackRecord.isPostponed() && !backStackRecord.interactsWith(arrayList, i4 + 1, i2)) {
                ...
                FragmentManagerImpl$StartEnterTransitionListener fragmentManagerImpl$StartEnterTransitionListener = new FragmentManagerImpl$StartEnterTransitionListener(backStackRecord, zBooleanValue);
    ...
    @Override // android.support.v4.app.FragmentManager
    public void registerFragmentLifecycleCallbacks(FragmentManager$FragmentLifecycleCallbacks fragmentManager$FragmentLifecycleCallbacks, boolean z) {
        this.mLifecycleCallbacks.add(new FragmentManagerImpl$FragmentLifecycleCallbacksHolder(fragmentManager$FragmentLifecycleCallbacks, z));
    }
    ...
    void dispatchOnFragmentPreAttached(@NonNull Fragment fragment, @NonNull Context context, boolean z) {
        ...
        for (FragmentManagerImpl$FragmentLifecycleCallbacksHolder fragmentManagerImpl$FragmentLifecycleCallbacksHolder : this.mLifecycleCallbacks) {
            if (!z || fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mRecursive) {
                fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mCallback.onFragmentPreAttached(this, fragment, context);
            }
        }
    }
    ...
    void dispatchOnFragmentAttached(@NonNull Fragment fragment, @NonNull Context context, boolean z) {
        ...
        for (FragmentManagerImpl$FragmentLifecycleCallbacksHolder fragmentManagerImpl$FragmentLifecycleCallbacksHolder : this.mLifecycleCallbacks) {
            if (!z || fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mRecursive) {
                fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mCallback.onFragmentAttached(this, fragment, context);
            }
        }
    }
    ...
    void dispatchOnFragmentPreCreated(@NonNull Fragment fragment, @Nullable Bundle bundle, boolean z) {
        ...
        for (FragmentManagerImpl$FragmentLifecycleCallbacksHolder fragmentManagerImpl$FragmentLifecycleCallbacksHolder : this.mLifecycleCallbacks) {
            if (!z || fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mRecursive) {
                fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mCallback.onFragmentPreCreated(this, fragment, bundle);
            }
        }
    }
    ...
    void dispatchOnFragmentCreated(@NonNull Fragment fragment, @Nullable Bundle bundle, boolean z) {
        ...
        for (FragmentManagerImpl$FragmentLifecycleCallbacksHolder fragmentManagerImpl$FragmentLifecycleCallbacksHolder : this.mLifecycleCallbacks) {
            if (!z || fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mRecursive) {
                fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mCallback.onFragmentCreated(this, fragment, bundle);
            }
        }
    }
    ...
    void dispatchOnFragmentActivityCreated(@NonNull Fragment fragment, @Nullable Bundle bundle, boolean z) {
        ...
        for (FragmentManagerImpl$FragmentLifecycleCallbacksHolder fragmentManagerImpl$FragmentLifecycleCallbacksHolder : this.mLifecycleCallbacks) {
            if (!z || fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mRecursive) {
                fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mCallback.onFragmentActivityCreated(this, fragment, bundle);
            }
        }
    }
    ...
    void dispatchOnFragmentViewCreated(@NonNull Fragment fragment, @NonNull View view, @Nullable Bundle bundle, boolean z) {
        ...
        for (FragmentManagerImpl$FragmentLifecycleCallbacksHolder fragmentManagerImpl$FragmentLifecycleCallbacksHolder : this.mLifecycleCallbacks) {
            if (!z || fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mRecursive) {
                fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mCallback.onFragmentViewCreated(this, fragment, view, bundle);
            }
        }
    }
    ...
    void dispatchOnFragmentStarted(@NonNull Fragment fragment, boolean z) {
        ...
        for (FragmentManagerImpl$FragmentLifecycleCallbacksHolder fragmentManagerImpl$FragmentLifecycleCallbacksHolder : this.mLifecycleCallbacks) {
            if (!z || fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mRecursive) {
                fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mCallback.onFragmentStarted(this, fragment);
            }
        }
    }
    ...
    void dispatchOnFragmentResumed(@NonNull Fragment fragment, boolean z) {
        ...
        for (FragmentManagerImpl$FragmentLifecycleCallbacksHolder fragmentManagerImpl$FragmentLifecycleCallbacksHolder : this.mLifecycleCallbacks) {
            if (!z || fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mRecursive) {
                fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mCallback.onFragmentResumed(this, fragment);
            }
        }
    }
    ...
    void dispatchOnFragmentPaused(@NonNull Fragment fragment, boolean z) {
        ...
        for (FragmentManagerImpl$FragmentLifecycleCallbacksHolder fragmentManagerImpl$FragmentLifecycleCallbacksHolder : this.mLifecycleCallbacks) {
            if (!z || fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mRecursive) {
                fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mCallback.onFragmentPaused(this, fragment);
            }
        }
    }
    ...
    void dispatchOnFragmentStopped(@NonNull Fragment fragment, boolean z) {
        ...
        for (FragmentManagerImpl$FragmentLifecycleCallbacksHolder fragmentManagerImpl$FragmentLifecycleCallbacksHolder : this.mLifecycleCallbacks) {
            if (!z || fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mRecursive) {
                fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mCallback.onFragmentStopped(this, fragment);
            }
        }
    }
    ...
    void dispatchOnFragmentSaveInstanceState(@NonNull Fragment fragment, @NonNull Bundle bundle, boolean z) {
        ...
        for (FragmentManagerImpl$FragmentLifecycleCallbacksHolder fragmentManagerImpl$FragmentLifecycleCallbacksHolder : this.mLifecycleCallbacks) {
            if (!z || fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mRecursive) {
                fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mCallback.onFragmentSaveInstanceState(this, fragment, bundle);
            }
        }
    }
    ...
    void dispatchOnFragmentViewDestroyed(@NonNull Fragment fragment, boolean z) {
        ...
        for (FragmentManagerImpl$FragmentLifecycleCallbacksHolder fragmentManagerImpl$FragmentLifecycleCallbacksHolder : this.mLifecycleCallbacks) {
            if (!z || fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mRecursive) {
                fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mCallback.onFragmentViewDestroyed(this, fragment);
            }
        }
    }
    ...
    void dispatchOnFragmentDestroyed(@NonNull Fragment fragment, boolean z) {
        ...
        for (FragmentManagerImpl$FragmentLifecycleCallbacksHolder fragmentManagerImpl$FragmentLifecycleCallbacksHolder : this.mLifecycleCallbacks) {
            if (!z || fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mRecursive) {
                fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mCallback.onFragmentDestroyed(this, fragment);
            }
        }
    }
    ...
    void dispatchOnFragmentDetached(@NonNull Fragment fragment, boolean z) {
        ...
        for (FragmentManagerImpl$FragmentLifecycleCallbacksHolder fragmentManagerImpl$FragmentLifecycleCallbacksHolder : this.mLifecycleCallbacks) {
            if (!z || fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mRecursive) {
                fragmentManagerImpl$FragmentLifecycleCallbacksHolder.mCallback.onFragmentDetached(this, fragment);
            }
        }
    }
    ...
    public View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, FragmentManagerImpl$FragmentTag.Fragment);
